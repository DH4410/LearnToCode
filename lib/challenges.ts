...
export const challenges: Challenge[] = [
  ...
  },
  {
    ...
    title: "Signal Print",
    badge: "Warm-up",
    story: "Your terminal is alive, but the control room wants a short, polished status ping.",
    mission: "Print any clear status message that sounds like a real command center update.",
    winText: "Pass when any line prints successfully.",
    hint: "You can print a plain string or store it in a variable first.",
    starter: "",
    placeholder: "Examples:\nshow \"Signal stable\"\nvariable status: \"Signal stable\"\nshow status",
  ...
  },
  {
    ...
    badge: "Lists",
    story: "A cargo robot needs a tiny inventory list before the next delivery sweep begins.",
    mission: "Build a list with three or more items and print it back out.",
    winText: "Pass when the console shows a list.",
    hint: "Any list items are fine. Try a list of tools, snacks, or rover parts.",
    starter: "",
    placeholder:
      "One action per line.\n\nExample:\nmake a list called cargo with 3, 5, 2\nshow cargo",
    check: (result) =>
      result.errors.length === 0 &&
  ...
  },
  {
    id: "smallest-beacon",
    category: "Data",
    title: "Smallest Beacon",
    badge: "Compare",
    story: "Three relay towers are blinking at different strengths and you need the weakest one.",
    mission: "Use 8, 3, 12, 5 and print the smallest value.",
    winText: "Pass when the console shows 3.",
    hint: "The smallest number in a list is supported directly.",
    starter: "",
    placeholder:
      "One action per line.\n\nTry:\nmake a list called beacons with 8, 3, 12, 5\nset lowest to smallest number in beacons\nshow lowest",
    check: (result) => result.errors.length === 0 && outputContains(result, "3"),
  },
  {
    id: "countdown-triple",
    category: "Control Flow",
    title: "Countdown Triple",
    badge: "Loops",
    story: "A launch bay needs three countdown pings before the hatch opens.",
    mission: "Output three countdown lines in any style.",
    winText: "Pass when the console shows three or more lines.",
    hint: "Repeat output is enough for this one; no special loop syntax is required.",
    starter: "",
    placeholder: "Example:\nshow \"3\"\nshow \"2\"\nshow \"1\"",
    check: (result) => result.errors.length === 0 && result.output.length >= 3,
  },
